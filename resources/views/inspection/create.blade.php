    ...
    <div class="page-inner">
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">Add Inspection</div>
            </div>

            <form method="POST" action="{{ route('inspections.store') }}" id="inspectionForm" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="body_condition" class="form-select" required>
                                    <option value="ok" {{ old('body_condition') == 'ok' ? 'selected' : '' }}>OK</option>
                                    <option value="damage" {{ old('body_condition') == 'damage' ? 'selected' : '' }}>Damage</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="display_status" class="form-select" required>
                                    <option value="working" {{ old('display_status') == 'working' ? 'selected' : '' }}>Working</option>
                                    <option value="not_working" {{ old('display_status') == 'not_working' ? 'selected' : '' }}>Not Working</option>
                                </select>
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="form-group">
                                ...
                                <select name="motherboard_status" class="form-select" required>
                                    <option value="ok" {{ old('motherboard_status') == 'ok' ? 'selected' : '' }}>OK</option>
                                    <option value="damage" {{ old('motherboard_status') == 'damage' ? 'selected' : '' }}>Damage</option>
                                </select>
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="form-group">
                                ...
                                <select name="power_card_status" class="form-select" required>
                                    <option value="ok" {{ old('power_card_status') == 'ok' ? 'selected' : '' }}>OK</option>
                                    <option value="damage" {{ old('power_card_status') == 'damage' ? 'selected' : '' }}>Damage</option>
                                </select>
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="form-group">
                                ...
                                <select name="sensor_status" class="form-select" required>
                                    <option value="ok" {{ old('sensor_status') == 'ok' ? 'selected' : '' }}>OK</option>
                                    <option value="damage" {{ old('sensor_status') == 'damage' ? 'selected' : '' }}>Damage</option>
                                </select>
                                @error('sensor_status')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
