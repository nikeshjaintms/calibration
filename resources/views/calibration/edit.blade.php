                        ...
                        <div class="row">
                                    ...
                                    <select name="user_id" class="form-select select2">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}"
                                                {{ old('user_id', $calibration->user_id) == $user->id ? 'selected' : '' }}>
                                                {{ $user->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('user_id')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" class="form-control"
                                        value="{{ old('date', $calibration->date) }}" required>
                                    @error('date')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="instrument" class="form-control"
                                        placeholder="e.g. Master Pressure Gauge"
                                        value="{{ old('instrument', $calibration->instrument) }}" required>
                                    @error('instrument')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="certificate_number" class="form-control"
                                        ...
                                        value="{{ old('certificate_number', $calibration->certificate_number) }}" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="flange_id" id="flange_id" class="form-select select2">
                                        ...
                                        @foreach($flanges as $flange)
                                            <option value="{{ $flange->id }}"
                                                {{ old('flange_id', $calibration->flange_id) == $flange->id ? 'selected' : '' }}>
                                                {{ $flange->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="flange_size" id="flange_size" class="form-control"
                                        placeholder="Flange Size"
                                        value="{{ old('flange_size', $calibration->flange_size) }}" readonly style="background:#eee;">
                                    @error('flange_size')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2 mt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="temperature" class="form-control" placeholder="25"
                                        value="{{ old('temperature', $calibration->temperature) }}">
                                </div>
                            </div>
                            ...
                            >{{ old('work_details', $displayWorkDetails) }}</textarea>
                        </div>
                                            ...
                                            @foreach ($points as $index => $point)
                                                <tr>
                                                    <td><input type="text"
                                                            ...
                                                            value="{{ is_array($point) ? $point['set_point_percentage'] : $point->set_point_percentage }}"
                                                            readonly></td>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="result" class="form-select" required>
                                        <option value="pass"
                                            {{ old('result', $calibration->result) == 'pass' ? 'selected' : '' }}>PASS
                                        </option>
                                        <option value="fail"
                                            {{ old('result', $calibration->result) == 'fail' ? 'selected' : '' }}>FAIL
                                        </option>
                                    </select>
                                </div>
                            </div>
