                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            {{-- @can('create-user') --}}
                                <a href="{{ route('users.create') }}" class=" float-end btn btn-sm btn-rounded btn-primary"><i class="fas fa-plus"></i> User</a>
                            {{-- @endcan --}}
                                    ...
                                    @forelse($users as $index => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{-- @can('edit-user') --}}
                                                    <a href="{{ route('users.edit', $item->id) }}" class="btn btn-lg btn-link btn-primary">
                                                        <i class="fa fa-edit">
                                                        </i></a>
                                                {{-- @endcan --}}
                                                {{-- @can('delete-user') --}}
